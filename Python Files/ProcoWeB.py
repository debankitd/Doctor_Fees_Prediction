...
#reading the pickle object wheere the model is build
model = pickle.load(open('website/lr_model.pkl','rb'))

#List of  location that is used in the ML model
...
#List of Degree used in the ML model
unique_degrees = [
    'MSc',
 'PGD',
 'MS',
...
#List of the Specialized flied the doctor's are expert on
...
#Encoding the the Input field collected from the webpage and converted into the Standard input format that can be used in ML model for Precdiction Analysis
